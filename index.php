...
<div class="slider-area">
    <div class="slider-active owl-carousel">
        <div class="single-slider slider-height-1 bg-img" style="background-image:url(assets/img/slider/background-slider1.jpg);">
            <div class="container">
                <div class="row">
                   ...
                   <div class="row no-gutters">
                       <div class="ml-auto col-lg-6 col-md-12">
                           <div class="testi-content bg-img default-overlay" >
                               ...
                               <p>Recomiendo esta distribuidora por el trato tan agradable y el surtido en productos para mi pequeño Toby, basto con agendar la entrega para poder recibir las croquetas </p>
                   ...
                   <div class="row no-gutters">
                        <div class="ml-auto col-lg-6 col-md-12">
                           <div class="testi-content bg-img default-overlay" >
                               ...
                               <p>Muy recomendable, me encanta la web que tienen porque siempre esta actualizada con nuevos produtos, alli encontre algunas cositas para mi pequeña gatita Sisi, gracias por la atencion.</p>
                                <div class="testi-info">
                                   <h5>Tania Vallejo</h5>
                                </div>
                                <div class="quote-style quote-right">
                    ...
                    <div class="row no-gutters">
                       <div class="ml-auto col-lg-6 col-md-12">
                           <div class="testi-content bg-img default-overlay" >
                               ...
                               <p>Me encanta esta distribuidora porque aunque no cuento con mucho tiempo para ir a recoger mi compra, ellos estan atentos a la entrega del producto </p>
                                <div class="testi-info">
                                   <h5>Fernando Vargas</h5>
                                </div>
                                <div class="quote-style quote-right">
                                   <i class="fa fa-quote-right"></i>
                                </div>
